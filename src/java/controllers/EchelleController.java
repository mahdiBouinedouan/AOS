...
import entity.Echelle;
import controllers.util.JsfUtil;
import controllers.util.JsfUtil.PersistAction;
import ejb.EchelleFacade;
...
public class EchelleController implements Serializable {
    ...
    @EJB
    private ejb.EchelleFacade ejbFacade;
    ...
    public Echelle getEchelle(java.lang.Integer id) {
    ...
    public static class EchelleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Echelle) {
                ...
                return getStringKey(o.getIDEchelle());
            } else {
